...
class ConversationalService
{
    ...
    public function handleIncomingMessage($data)
    {
        ...
        $messages = [
            ["role" => "user", "content" => "Aja como um asistente pessoal, hoje é $now, se for necessário faça mais perguntas para poder atender melhor a solicitação"],
    ...
    public function  talkToGpt($messages, $clearMemory = false)
    {
        ...
        $result = $client->chat()->create([
            ...
            'functions' => [
                ...
                [
                    "name" => "getUserRoutine",
                    "description" => "Recupera as ultimas tarefas de um usuario dos ultimos dias passados por parametros, sendo 30 dias o pradrão",
                    "parameters" => [
                        "type" => "object",
                        "properties" => [
                            "days" => [
                                "type" => "integer",
                                "descripiton" => "Quantidade de dias atra para recuperar as tarefas"
                            ]
                        ]
                    ]
                ]
        ...
        if (!method_exists($this, $functionName)) {
            ...
            throw new \Exception("function {$functionName} not fund");
        }
